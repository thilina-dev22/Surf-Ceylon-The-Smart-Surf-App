...
// GET /api/sessions/user/:userId/insights - Get user insights
...
// GET /api/sessions/spot/:spotId/stats - Get spot statistics
router.get('/spot/:spotId/stats', async (req, res) => {
  // Check if MongoDB is available
  if (!req.isMongoConnected) {
    return res.status(503).json({ 
      error: 'Session tracking temporarily unavailable',
