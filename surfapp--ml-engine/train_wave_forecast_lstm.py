...
def plot_training_history(history):
    ...
    plt.tight_layout()
    plt.savefig('training_history_multioutput.png', dpi=150, bbox_inches='tight')
    print("✅ Saved: training_history_multioutput.png")
...
def main():
    ...
    print(f"  📊 training_history_multioutput.png")
